...
public class BasicGameApp implements Runnable, KeyListener {
    ...
    private void render() {
        ...
        while (i < dealer.hand.getCards().size()) {

            g.drawRect(dx, 120, 80, 120);
            g.drawString(dealer.hand.getCards().get(i).namei, dx + 10, 140);
        ...
        for (int l = 0; i < player.hand.getCards().size(); i++) {
            ...
            g.drawString(player.hand.getCards().get(l).namei, ex + 10, 360);
